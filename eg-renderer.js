	...
	var EgRenderer = function (_window$HTMLElement) {
	  ...
	  _createClass(EgRenderer, [{
	    ...
	    value: function render(graphData) {
	      ...
	      var _centerTransform = centerTransform(layoutWidth, layoutHeight, canvasWidth, canvasHeight, margin),
	      ...
	      try {
	        for (var _iterator4 = graph.edges()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	          ...
	          var points = layout.edges[u][v].points;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AbstractGraph = __webpack_require__(301);
	...
	var MutableGraph = function (_AbstractGraph) {
	  ...
	  function MutableGraph() {
	    ...
	    var _this = _possibleConstructorReturn(this, (MutableGraph.__proto__ || Object.getPrototypeOf(MutableGraph)).call(this));
	  ...
	  _createClass(MutableGraph, [{
	    ...
	    value: function removeVertex(u) {
	      ...
	      try {
	        for (var _iterator = this.outVertices(u)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var v = _step.value;
	      ...
	      try {
	        for (var _iterator2 = this.inVertices(u)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var _v = _step2.value;

	          this.removeEdge(_v, u);
	        }
	      } catch (err) {
	        _didIteratorError2 = true;
	        _iteratorError2 = err;
	...
	var AbstractGraph = function () {
	  ...
	  _createClass(AbstractGraph, [{
	    ...
	    value: function edges() {
	      ...
	      try {
	        for (var _iterator = this.vertices()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          try {
	            for (var _iterator2 = this.outVertices(u)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	              var v = _step2.value;
	    ...
	    value: regeneratorRuntime.mark(function outEdges(u) {
	      ...
	      return regeneratorRuntime.wrap(function outEdges$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.prev = 3;
	              _iterator3 = this.outVertices(u)[Symbol.iterator]();
	    ...
	    value: regeneratorRuntime.mark(function inEdges(u) {
	      ...
	      return regeneratorRuntime.wrap(function inEdges$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              ...
	              _context2.prev = 3;
	              _iterator4 = this.inVertices(u)[Symbol.iterator]();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graph = __webpack_require__(299);
	var accessor = __webpack_require__(303);
	var connectedComponents = __webpack_require__(304);
	var groupLayers = __webpack_require__(305);
	var layerAssignment = __webpack_require__(306);
	var normalize = __webpack_require__(309);
	var crossingReduction = __webpack_require__(310);
	var positionAssignment = __webpack_require__(314);
	var bundleEdges = __webpack_require__(321);

	var initGraph = function initGraph(gOrig, _ref) {
	  var ltor = _ref.ltor,
	      vertexWidth = _ref.vertexWidth,
	      vertexHeight = _ref.vertexHeight,
	      edgeWidth = _ref.edgeWidth,
	      layerMargin = _ref.layerMargin,
	      vertexMargin = _ref.vertexMargin,
	      vertexLeftMargin = _ref.vertexLeftMargin,
	      vertexRightMargin = _ref.vertexRightMargin,
	      vertexTopMargin = _ref.vertexTopMargin,
	      vertexBottomMargin = _ref.vertexBottomMargin;
	  ...
	  try {
	    for (var _iterator = gOrig.vertices()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var u = _step.value;

	      var d = gOrig.vertex(u);
	      var w = vertexWidth({ u: u, d: d });
	      var h = vertexHeight({ u: u, d: d });
	      var horizontalMargin = vertexLeftMargin({ u: u, d: d }) + vertexRightMargin({ u: u, d: d });
	      var verticalMargin = vertexTopMargin({ u: u, d: d }) + vertexBottomMargin({ u: u, d: d });
	      g.addVertex(u, {
	  ...
	  try {
	    for (var _iterator2 = gOrig.edges()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	var simplify = function simplify(points, ltor) {
	  ...
	  while (index < points.length - 1) {
	    ...
	    var x1 = ltor ? points[index + 1][1] : points[index + 1][0];
	    if (x0 === x1) {
	...
	var buildResult = function buildResult(g, layers, ltor) {
	  ...
	  try {
	    for (var _iterator4 = g.vertices()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	  ...
	  try {
	    for (var _iterator5 = layers[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	      ...
	      try {
	        for (var _iterator8 = _layer[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	          var _u3 = _step8.value;

	          maxHeight = Math.max(maxHeight, g.vertex(_u3).origHeight || 0);
	        }
	      } catch (err) {
	  ...
	  for (var i = 0; i < layers.length; ++i) {
	    var layer = layers[i];
	    var layerHeight = layerHeights[i];
	    var _iteratorNormalCompletion6 = true;
	    var _didIteratorError6 = false;
	    var _iteratorError6 = undefined;

	    try {
	      for (var _iterator6 = layer[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	        var u = _step6.value;
	        ...
	        if (!uNode.dummy) {
	          ...
	          try {
	            for (var _iterator7 = g.outVertices(u)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	              var v = _step7.value;
	...
	var SugiyamaLayouter = function () {
	  ...
	  _createClass(SugiyamaLayouter, [{
	    ...
	    value: function layout(gOrig) {
	      ...
	      var layers = groupLayers(g, layerMap, true);
	      normalize(g, layers, layerMap, this.edgeMargin(), this.layerMargin());
	      var normalizedLayers = layers.map(function () {
	        return [];
	      });
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          var vertices = new Set(component);
	          var componentLayers = layers.map(function (h) {
	            return h.filter(function (u) {
	              return vertices.has(u);
	            });
	          });
	          _this.crossingReduction().call(g, componentLayers);
	          for (var _i = 0; _i < layers.length; ++_i) {
	            ...
	            try {
	              for (var _iterator10 = componentLayers[_i][Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	                var _u4 = _step10.value;

	                normalizedLayers[_i].push(_u4);
	              }
	            } catch (err) {
	        ...
	        for (var _iterator9 = connectedComponents(g)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	          _loop();
	        }
	      } catch (err) {
	      ...
	      for (var i = 0; i < normalizedLayers.length; ++i) {
	        var layer = normalizedLayers[i];
...
/***/ function(module, exports) {
	...
	var markChildren = function markChildren(graph, u, id, result) {
	  if (result.has(u)) {
	    var prevId = result.get(u);
	    if (prevId !== id) {
	      var _iteratorNormalCompletion = true;
	      var _didIteratorError = false;
	      var _iteratorError = undefined;
	  ...
	  try {
	    for (var _iterator2 = graph.outVertices(u)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	      var _v = _step2.value;

	      markChildren(graph, _v, id, result);
	    }
	  } catch (err) {
	    _didIteratorError2 = true;
	    _iteratorError2 = err;
	...
	var connectedComponents = function connectedComponents(graph) {
	  ...
	  var componentIds = new Set(componentIdMap.values());
	  return Array.from(componentIds).map(function (u) {
	    return graph.vertices().filter(function (v) {
	      return componentIdMap.get(v) === u;
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LongestPath = __webpack_require__(307);
	var QuadHeuristic = __webpack_require__(308);

	module.exports = { LongestPath: LongestPath, QuadHeuristic: QuadHeuristic };
...
/***/ function(module, exports) {
	...
	var longestPath = function longestPath(g) {
	  ...
	  try {
	    for (var _iterator3 = g.vertices()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      var _u = _step3.value;

	      minLayer = Math.min(minLayer, layers[_u]);
	    }
	  } catch (err) {
	    _didIteratorError3 = true;
	    _iteratorError3 = err;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var quadHeuristic = function quadHeuristic(g, repeat) {
	  var layers = new LongestPath().call(g);
	  ...
	  try {
	    for (var _iterator = g.vertices()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      minLayer = Math.min(minLayer, layers[_u3]);
	      maxLayer = Math.max(maxLayer, layers[_u3]);
	    }
	  } catch (err) {
	    _didIteratorError = true;
	    _iteratorError = err;
	  ...
	  for (var loop = 0; loop < repeat; ++loop) {
	    ...
	    try {
	      for (var _iterator5 = vertices[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	        ...
	        try {
	          for (var _iterator6 = g.inVertices(_u2)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	            var v = _step6.value;
	        ...
	        try {
	          for (var _iterator7 = g.outVertices(_u2)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	            var _v = _step7.value;

	            var _layer = layers[_v];
	            rightMin = Math.min(rightMin, _layer);
	            sum += _layer;
	            count += 1;
	          }
	        } catch (err) {
	        ...
	        layers[_u2] = Math.min(rightMin - 1, Math.max(leftMax + 1, Math.round(sum / count)));
	      }
	    } catch (err) {
	      _didIteratorError5 = true;
	      _iteratorError5 = err;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayerSweep = __webpack_require__(311);

	module.exports = { LayerSweep: LayerSweep };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var accessor = __webpack_require__(303);
	var baryCenter = __webpack_require__(312);
	    ...
	    value: function call(g, layers) {
	      ...
	      for (var loop = 0; loop < repeat; ++loop) {
	        ...
	        for (var _i = n - 1; _i > 0; --_i) {
	          method(g, layers[_i - 1], layers[_i], true);
	        }
	      }
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var layerMatrix = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Brandes = __webpack_require__(315);

	module.exports = { Brandes: Brandes };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var markConflicts = __webpack_require__(316);
	var verticalAlignment = __webpack_require__(318);
	var horizontalCompaction = __webpack_require__(320);
	...
	var brandes = function brandes(g, layers) {
	    ...
	    if (_direction.rtol) {
	      ...
	      try {
	        for (var _iterator4 = g.vertices()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	          ...
	          _maxX = Math.max(_maxX, xs[_u2][_i]);
	        }
	      } catch (err) {
	        _didIteratorError4 = true;
	        _iteratorError4 = err;
	      ...
	      try {
	        for (var _iterator5 = g.vertices()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	          var _u3 = _step5.value;

	          xs[_u3][_i] += minWidthRight - _maxX;
	        }
	      } catch (err) {
	        _didIteratorError5 = true;
	        _iteratorError5 = err;
	      ...
	      try {
	        for (var _iterator6 = g.vertices()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	          var _u4 = _step6.value;

	          _minX = Math.min(_minX, xs[_u4][_i]);
	        }
	      } catch (err) {
	        _didIteratorError6 = true;
	        _iteratorError6 = err;
	      ...
	      try {
	        for (var _iterator7 = g.vertices()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	          var _u5 = _step7.value;

	          xs[_u5][_i] += minWidthLeft - _minX;
	        }
	      } catch (err) {
	        _didIteratorError7 = true;
	        _iteratorError7 = err;
	  ...
	  try {
	    for (var _iterator8 = g.vertices()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	      var _u7 = _step8.value;

	      sort(xs[_u7]);
	      g.vertex(_u7).x = (xs[_u7][1] + xs[_u7][2]) / 2;
	    }
	  } catch (err) {
	    _didIteratorError8 = true;
	    _iteratorError8 = err;
	...
	var normalize = function normalize(g) {
	  ...
	  try {
	    for (var _iterator9 = g.vertices()[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	      var u = _step9.value;
	  ...
	  try {
	    for (var _iterator10 = g.vertices()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	      var _u8 = _step10.value;

	      var _uNode = g.vertex(_u8);
	      _uNode.x -= xMin;
	      _uNode.y -= yMin;
	    }
	  } catch (err) {
	...
	var Brandes = function () {
	  ...
	  _createClass(Brandes, [{
	    ...
	    value: function call(g, layers) {
	      ...
	      try {
	        for (var _iterator11 = layers[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	          ...
	          try {
	            for (var _iterator12 = layer[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
	              var u = _step12.value;
	          ...
	          try {
	            for (var _iterator13 = layer[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
	              var _u9 = _step13.value;

	              g.vertex(_u9).y = yOffset;
	            }
	          } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var layerEdges = __webpack_require__(317);
	...
	var markConflicts = function markConflicts(g, layers) {
	  ...
	  var dummy = {};
	  var order = {};
	  var isInner = function isInner(_ref) {
	    var _ref2 = _slicedToArray(_ref, 2),
	        u = _ref2[0],
	        v = _ref2[1];
	  ...
	  for (var i = 1; i < h; ++i) {
	    var h1 = layers[i];
	    var h2 = layers[i + 1];
	    var edges = layerEdges(g, h1, h2);

	    var _split = split(edges, isInner),
	        _split2 = _slicedToArray(_split, 2),
	        innerSegments = _split2[0],
	        outerSegments = _split2[1];
	    ...
	    try {
	      for (var _iterator3 = innerSegments[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	        ...
	        try {
	          for (var _iterator4 = outerSegments[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            var _step4$value = _slicedToArray(_step4.value, 2),
	                u2 = _step4$value[0],
	                v2 = _step4$value[1];
	...
	var layerEdges = function layerEdges(g, h1, h2) {
	  ...
	  try {
	    for (var _iterator = h2[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      try {
	        for (var _iterator2 = g.inVertices(v)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var u = _step2.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var median = __webpack_require__(319);

	var verticalAlignment = function verticalAlignment(g, layers, _ref) {
	  var _ref$rtol = _ref.rtol,
	      rtol = _ref$rtol === undefined ? false : _ref$rtol,
	      _ref$btot = _ref.btot,
	      btot = _ref$btot === undefined ? false : _ref$btot;

	  var iterLayers = regeneratorRuntime.mark(function iterLayers() {
	    var i, _i;

	    return regeneratorRuntime.wrap(function iterLayers$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            if (!btot) {
	  ...
	  var iterLayer = regeneratorRuntime.mark(function iterLayer(layer) {
	    var i, _i2;

	    return regeneratorRuntime.wrap(function iterLayer$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            if (!rtol) {
	  ...
	  var degree = btot ? function (u) {
	    return g.outDegree(u);
	  } : function (u) {
	    return g.inDegree(u);
	  };
	  var med = btot ? function (g, layers) {
	    return median(g, layers, true);
	  } : function (g, layers) {
	    return median(g, layers);
	  };
	  var _iteratorNormalCompletion = true;
	  var _didIteratorError = false;
	  var _iteratorError = undefined;
	  ...
	  try {
	    for (var _iterator2 = iterLayers()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	      ...
	      try {
	        for (var _iterator3 = iterLayer(layer)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          var v = _step3.value;
	          ...
	          if (degree(v) > 0) {
	            ...
	            try {
	              for (var _iterator4 = medians[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	                var _u = _step4.value;

	                if (!edge(_u, v).type1Conflict && !edge(_u, v).type2Conflict) {
	                  if (rtol ? r > g.vertex(_u).order : r < g.vertex(_u).order) {
	                    g.vertex(v).align = g.vertex(v).root = g.vertex(_u).root;
	                    g.vertex(_u).align = v;
	                    r = g.vertex(_u).order;
	                    break;
	                  }
...
/***/ function(module, exports) {
	...
	var median = function median(g, v) {
	  ...
	  var vertices = Array.from(inverse ? g.outVertices(v) : g.inVertices(v));
	...
	var horizontalCompaction = function horizontalCompaction(g, layers, _ref) {
	  ...
	  try {
	    for (var _iterator3 = g.vertices()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      ...
	      var _uNode = g.vertex(_u2);
	      _uNode.x = g.vertex(_uNode.root).x;
	    }
	  } catch (err) {
	    _didIteratorError3 = true;
	    _iteratorError3 = err;
	  ...
	  try {
	    for (var _iterator4 = g.vertices()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	      var _u3 = _step4.value;

	      var _uNode2 = g.vertex(_u3);
	      var shift = g.vertex(g.vertex(_uNode2.root).sink).shift;
	      if (shift < Infinity) {
	        _uNode2.x += shift;
	      }
	    }
...
/***/ function(module, exports) {
	...
	var segment = regeneratorRuntime.mark(function segment(graph, vertices, upper) {
	  var seq, lastParent, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, u, d;

	  return regeneratorRuntime.wrap(function segment$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	        ...
	        case 2:
	          seq = [];
	          lastParent = graph.vertex(vertices[0])[upper ? 'v' : 'u'];
	          _iteratorNormalCompletion = true;
	          _didIteratorError = false;
	          _iteratorError = undefined;
	          _context.prev = 7;
	          _iterator = vertices[Symbol.iterator]();
	  ...
	  }, segment, this, [[7, 23, 27, 35], [28,, 30, 34]]);
	});

	var adjustPos = function adjustPos(graph, vertices, ltor) {
	  var sumPos = 0;
	  var totalWidth = 0;
	  var _iteratorNormalCompletion2 = true;
	  var _didIteratorError2 = false;
	  ...
	  var offset = sumPos / vertices.length - (totalWidth - 1) / 2;
	  var _iteratorNormalCompletion3 = true;
	  var _didIteratorError3 = false;
	  var _iteratorError3 = undefined;
	  ...
	  try {
	    for (var _iterator3 = vertices[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      ...
	      graph.vertex(_u)[ltor ? 'x' : 'y'] = offset;
	      offset += graph.vertex(_u).origWidth || 0;
	    }
	  } catch (err) {
	    _didIteratorError3 = true;
	    _iteratorError3 = err;
	...
	var bundleEdges = function bundleEdges(graph, layers, ltor) {
	  for (var i = 0; i < layers.length - 1; ++i) {
	    ...
	    try {
	      for (var _iterator4 = segment(graph, layers[i], false)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	        var vertices = _step4.value;
	  ...
	  for (var _i = layers.length - 1; _i > 0; --_i) {
	    ...
	    try {
	      for (var _iterator5 = segment(graph, layers[_i], true)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	        var _vertices = _step5.value;

	        adjustPos(graph, _vertices, ltor);
	      }
	    } catch (err) {
	      _didIteratorError5 = true;
	      _iteratorError5 = err;
